...
const images = [
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/aminy-generation%2Fminy-b76b3879-93df-4284-87b4-e38c514a68d7?alt=media&token=6d7fda4f-2856-41db-8c97-fea4ef5f",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/aminy-generation%2Fminy-1b3812f8-334c-4c94-baae-67350c8b2978?alt=media&token=14a30de9-1fa5-46fa-9727-967dd7c45ca6",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/aminy-generation%2Fminy-b97ee15f-5b58-4f34-b818-a72b5c22110c?alt=media&token=68d94993-8c8d-4768-bd8b-59e1739db091",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---Disappearing-Clothes---Coota-Brown?alt=media&token=7fa10b42-525d-411d-922b-0cff2f7f9f21",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---Roll-On-Me---Lavaud---Oh-My---Lavaud---In-This-Room---Lavaud---3AM-In-London---Lavaud?alt=media&token=bcbbbf07-f00c-4f2a-b13b-25b52eef3f45",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---3AM-In-London---Lavaud---Booboo---Yaeji---Lost-In-Between---XTIE-Feat.-Anniina---%40MSMSMSM_FOREVER---Sophie?alt=media&token=2f9ce9ca-f656-4e42-b8cf-4ff09a4a6ec6",
   ...
   {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---Cold-Reactor---Everything-Everything---Grace---IDLES---Off-With-Her-Tits---Allie-X---Ruined---Adrianne-Lenker?alt=media&token=9cd51428-16b6-466a-b8d3-b148c465b8fb",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---Karma---Taylor-Swift---Never-Meant---American-Football---Spanish-Sahara---Foals---Cassius---Foals?alt=media&token=e043833f-bd13-4e03-91a8-a467f4c10339",
   ...
   {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---Kill-Bill---SZA---As-It-Was---Harry-Styles---Dark-Red---Steve-Lacy---Ivy---Frank-Ocean?alt=media&token=851e15a2-e3e6-48e9-991d-6eaadec84e0c",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---SILKSCREEN---Avara---Let-It-Go...-(Outro)---Avara---Been-Some-Time-(Need-U)---Avara---Duck-%26-Roll---Avara?alt=media&token=dbff874c-f342-454e-8745-81a22d386aa5",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---Toxic---Tai-Mistyque---Be-Without-Me---Tai-Mistyque---Reminder---Tai-Mistyque---Where-Do-I-Go---Tai-Mistyque?alt=media&token=70a981b0-83bc-48c3-bd02-afa69b842e90",
  ...
  {
    image_url: "https://firebasestorage.googleapis.com/v0/b/subway-musician-564bd.appspot.com/o/a-mixtapes%2FMiny-Vinyl-Playlist-(Mixtape)-featuring-tracks---Attitude---Buggin---Snack-Run---Buggin---All-Eyes-On-You---Buggin---Brainfreeze---Buggin?alt=media&token=7c9abd3e-2768-4e6c-9cd5-9e9967148815",
          ...
          <div className="absolute top-0 left-0 right-0 px-4 py-2 ">
            <div className="flex items-center justify-between">
              <div>
                ...
                <a
                  href={mixtape.link || mixtape.shortened_link}
                  target="_blank"
...
const ImageGallery = () => {
    ...
    try {
      ...
      const votePromises = images.map(async (mixtape) => {
        const { data: mixtapeData, error } = await supabase
          .from('mixtapes')
          .select('voted_by')
          .eq('id', mixtape.MixtapeId)
          .single();

        if (error) throw error;
        
        const hasVotedToday = mixtapeData?.voted_by?.some(vote =>
          vote.userId === userId &&
          new Date(vote.date).toDateString() === new Date().toDateString()
        );
    ...
    const fetchVotes = async () => {
      try {
        ...
        const votePromises = images.map(async (mixtape) => {
          ...
          if (error) {
            // If mixtape doesn't exist, create it
            const { error: insertError } = await supabase
              .from('mixtapes')
              .insert([{
                id: mixtape.MixtapeId,
                vote_count: 0,
                voted_by: []
              }]);
            ...
            newVotes[mixtape.MixtapeId] = mixtapeData.vote_count || 0;
          }
        });
        await Promise.all(votePromises);
        setVotes(newVotes);
  ...
  const handleUpvote = async (mixtapeId) => {
    ...
    try {
      ...
      const { data: mixtapeData, error: fetchError } = await supabase
        .from('mixtapes')
        .select('vote_count, voted_by')
        .eq('id', mixtapeId)
        .single();

      if (fetchError) throw fetchError;

      // Update mixtape with new vote
      const { error: updateError } = await supabase
        .from('mixtapes')
        .update({
          vote_count: (mixtapeData.vote_count || 0) + 1,
          voted_by: [...(mixtapeData.voted_by || []), { userId: user.id, date: new Date().toISOString() }]
        })
        .eq('id', mixtapeId);
  ...
  const handleVote = async (mixtape) => {
    try {
      // Get the current mixtape data
      const { data: mixtapeData, error: fetchError } = await supabase
        .from('mixtapes')
        .select('vote_count, is_favorite')
        .eq('id', mixtape.MixtapeId)
        .single();

      if (fetchError) throw fetchError;

      // Toggle favorite status and update vote count
      const newIsFavorite = !mixtapeData.is_favorite;
      const newVoteCount = mixtapeData.vote_count + (newIsFavorite ? 1 : -1);
      ...
      setMixtapes(prevMixtapes => 
        prevMixtapes.map(m => 
          m.MixtapeId === mixtape.MixtapeId 
            ? { ...m, vote_count: newVoteCount, is_favorite: newIsFavorite }
            : m
        )
      );
    } catch (error) {
  ...
  const handleComment = async (mixtape) => {
    try {
      // Get the current mixtape data
      const { data: mixtapeData, error: fetchError } = await supabase
        .from('mixtapes')
      ...
      const { error: updateError } = await supabase
        .from('mixtapes')
        .update({
          comment_count: mixtapeData.comment_count + 1
        })
        .eq('id', mixtape.MixtapeId);
      ...
      setMixtapes(prevMixtapes => 
        prevMixtapes.map(m => 
          m.MixtapeId === mixtape.MixtapeId 
            ? { ...m, comment_count: mixtapeData.comment_count + 1 }
            : m
        )
      );
    } catch (error) {
